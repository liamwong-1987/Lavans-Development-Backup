...
Lavans 基于大雄（GitHub：[@hero8152](https://github.com/hero8152)）的 [Infinite Canvas](https://github.com/hero8152/Infinite-Canvas) 进行学习、改造与持续开发。感谢大雄及原项目贡献者的创作与分享，谨向原作致敬。

本仓库仅作为个人后续开发、技术学习和维护使用的 GitHub 备份，不用于商业发行，也不代表原作者对本项目的认可或背书。任何对外发布或分发均须保留原作者与原项目来源，并遵守原项目“禁止商业用途、二次开发保持开源”的许可要求以及各第三方组件的许可条款。
